-- Wstawianie danych do tabeli engines
...
-- Wstawianie danych do tabeli gearboxes
...
-- Wstawianie danych do tabeli models
...
INSERT INTO cars (registration_number, last_service_date, mileage, model_id, insurance_expiry_date, rental_price_per_day, base_price)
VALUES
('ABC1234', '2024-12-01', 25000, 1, '2025-12-01', 120.50, 22000),
('XYZ5678', '2024-11-15', 18000, 2, '2025-11-15', 150.75, 35000),
('LMN9876', '2024-09-30', 12000, 3, '2025-09-30', 90.30, 16000);
